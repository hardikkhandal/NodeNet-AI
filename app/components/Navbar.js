          ...
          >
            <li>
              <a
                className={
                  nav
                    ? "block py-2 pl-3 pr-4 text-white  rounded md:bg-transparent md:text-blue-700 md:p-0 dark:text-blue-500 md:dark:hover:text-gray-900 md:dark:text-white"
                    : "block py-2 pl-3 pr-4 text-white  rounded md:bg-transparent md:text-blue-700 md:p-0 dark:text-blue-500 md:dark:hover:text-gray-900 md:dark:text-blue-500"
                }
                aria-current="page"
              >
                Home
